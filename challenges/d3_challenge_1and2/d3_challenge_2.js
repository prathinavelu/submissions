...
var margin = {'bottom':30,'top':20,'left':40,'right':25}
var h = 400 - margin.bottom - margin.top;
var w = 400 - margin.left - margin.right;
...
var ymax = d3.max(data2, function(d) { return +d.y;} )
var xmax = d3.max(data2, function(d) { return +d.x;} )
...
svg.append("path")
    .attr("class", "line")
    .attr("d", function(d) {return line(data2.sort(compareNumbers)); })
...
var x = d3.scale.ordinal()
    .domain(categories).rangeBands([0, w]);
var xAxis = d3.svg.axis()
    .scale(x)
    .orient('bottom')
svg.append('g')
